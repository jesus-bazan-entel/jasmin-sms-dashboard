...
const messagesSlice = createSlice({
  ...
  reducers: {
    ...
    addMessage: (state, action) => { state.messages.unshift(action.payload); },
...
export const { setLoading, setMessages, addMessage, updateMessage, setCurrentMessage, setFilters, setPagination, setError, clearError } = messagesSlice.actions;
